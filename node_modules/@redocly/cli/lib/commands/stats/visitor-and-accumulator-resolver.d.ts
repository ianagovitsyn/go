...
export declare function resolveStatsVisitorAndAccumulator(specVersion: SpecVersion): {
    statsVisitor: {
        ...
        Tag: {
            leave(tag: import("@redocly/openapi-core").Oas3Tag): void;
        };
        ChannelMap: {
            Channel: {
                leave(): void;
        ...
        Link: {
            leave(link: import("core/lib/typings/openapi.js").Oas3Link): void;
        };
        WebhooksMap: {
            Operation: {
                leave(operation: import("@redocly/openapi-core").Oas3Operation): void;
            };
        };
        Paths: {
            PathItem: {
