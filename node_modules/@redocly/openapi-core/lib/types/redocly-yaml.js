...
const builtInDecorators = [...builtInOas3Decorators, ...builtInOas2Decorators];
...
const Rules = {
    ...
    additionalProperties: (value, key) => {
        ...
        else if (builtInRules.includes(key)) {
            if (typeof value === 'string') {
                return { enum: ['error', 'warn', 'off'] };
            }
            else {
...
const Decorators = {
    ...
    additionalProperties: (value, key) => {
        if (builtInDecorators.includes(key)) {
            if (typeof value === 'string') {
                return { enum: ['on', 'off'] };
            }
            else {
